...
namespace TGL.Server.Controller
{
    ...
    {
        //Предоставляет доступ к локальным и удаленным процессам и позволяет
        //запускать и останавливать локальные системные процессы.
        ...
        /// если manager не указан, то используется FileManager в качестве DataManager
        /// Если нет, то процесс запускается в фоновом режиме
        /// </summary>
        ...
        /// <summary>
        /// Инициализируйте переменные. Если менеджер не указан, он использует FileManager в качестве DataManager
        /// </summary>
        /// <param name="manager"></param>
        /// <param name="port"></param>
        public ServerController(DataManager manager, int port) : this(manager, null, port) { }
        /// <summary>
        /// Инициализируйте переменные.Если представление не предоставлено, оно запускает процесс в фоновом режиме.
        /// </summary>
        /// <param name="view"></param>
        public ServerController(IServerView view) : this(null, view) { }
        /// <summary>
        /// Управлять входящим сообщением из данного клиентского сокета.
        /// </summary>
        ...
        /// <summary>
        /// прерывание между пользователями
        /// </summary>
        ...
        /// <summary>
        /// отправка сообщения от отмене от пользователя from другому пользователю to
        /// </summary>
        /// <param name="to"></param>
