...
namespace TGL.Client.Controller
{
    ...
    public class ClientController : DefaultController
    {
        ...
        /// <summary>
        /// сообщение об окончании игры на сервер..
        /// </summary>
        ...
        /// <summary>
        /// отправить сообщение на сервер об игре
        /// </summary>
        /// <param name="gameStuff"></param>
        ...
        /// <summary>
        /// отправить сообщение на сервер от пользователя
        /// </summary>
        ...
        /// <summary>
        /// сообщение о выгоде из игры на сервер
        /// </summary>
        ...
        /// <summary>
        /// сообщение с запросом на игру на сервер
        /// </summary>
        /// <param name="user"></param>
        ...
        /// <summary>
        /// ответное сообщение игры на сервер.
        /// </summary>
        /// <param name="user"></param>
        ...
        /// <summary>
        /// Запуск клиентского процесса и соедините его с сервером.
        /// </summary>
        ...
        /// <summary>
        /// Отправка сообщения для входа на сервер.
        /// </summary>
        /// <param name="user"></param>
        /// <param name="enrolled">True если данный пользователь зарегистрирован</param>
        /// <param name="save">True если сервер должен сохранить заданного пользователя</param>
        ...
        /// <summary>
        /// Отправка сообщения об отключении на сервер.
        /// </summary>
